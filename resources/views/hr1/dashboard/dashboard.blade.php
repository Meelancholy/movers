...
@section('content')
    <div class="p-8 min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mb-10">
            <!-- Employees Card -->
            <div class="bg-blue-400 p-6 rounded-lg shadow-lg flex items-center justify-between text-white">
                <div>
            ...
            <!-- Payroll Processed -->
            <div class="bg-teal-400 p-6 rounded-lg shadow-lg flex items-center justify-between text-white">
                <div>
            ...
            <!-- Pending Requests -->
            <div class="bg-orange-400 p-6 rounded-lg shadow-lg flex items-center justify-between text-white">
                <div>
            ...
            <!-- Open Positions -->
            <div class="bg-pink-400 p-6 rounded-lg shadow-lg flex items-center justify-between text-white">
                <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div class="h-44 bg-gray-100 rounded-lg flex items-center justify-center">
        ...
        <div class="mt-12 bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Chart or Summary 1 -->
                <div class="bg-blue-400 p-6 rounded-lg text-white flex items-center justify-center">
                    <span class="text-lg font-bold">[Chart Placeholder]</span>
                </div>

                <!-- Chart or Summary 2 -->
                <div class="bg-green-400 p-6 rounded-lg text-white flex items-center justify-center">
                    <span class="text-lg font-bold">[Chart Placeholder]</span>
                </div>
            </div>
        </div>
