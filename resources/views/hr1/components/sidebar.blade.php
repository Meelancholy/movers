<div class="sidebar">
    <aside x-data="{ open: $parent.open }" :class="open ? 'translate-x-0' : '-translate-x-full'"
        class="p-1 w-80 bg-white font-bold text-sm min-h-full border-2 text-blue-600 fixed transform transition-transform duration-300 ease-in-out max-h-screen overflow-y-auto">
        ...
        <a href="{{route('dashboard')}}">
            <img class="py-10 px-4" src="{{ asset('images/logo.png') }}" alt="Logo">
        </a>
        <hr class="border-gray-300 mx-10 my-4">
        ...
        <ul class="text-l">
            <li>
                <a href="{{route('dashboard')}}" class="flex items-center px-2 rounded-lg text-blue-600 hover:bg-blue-200 active:bg-blue-400 hover:text-blue-800 cursor-pointer py-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-layout-dashboard">
...
<li x-data="{ open: false }">
    <a @click="open = !open" class="flex items-center justify-between py-4 px-2 rounded-lg text-blue-600 hover:bg-blue-200 active:bg-blue-400 hover:text-blue-800 cursor-pointer">
        <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-cog">
    ...
    <ul x-show="open" x-transition:enter="transition-all ease-in-out duration-300 transform"
        ...
        <li>
            <a href="{{ route('payroll.create') }}" class="flex items-center py-4 px-2 rounded-lg text-blue-600 hover:bg-blue-200 active:bg-blue-400 hover:text-blue-800">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-contact">
                    <path d="M16 2v2"/>
        ...
        <li>
            <a href="{{ route('payroll.records') }}" class="flex items-center py-4 px-2 rounded-lg text-blue-600 hover:bg-blue-200 active:bg-blue-400 hover:text-blue-800">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users-round">
            ...
            <li>
                <a href="{{route('compensation.index')}}" class="flex items-center px-2 rounded-lg text-blue-600 hover:bg-blue-200 active:bg-blue-400 hover:text-blue-800 cursor-pointer py-4">
            ...
            <li>
                <a href="#" class="flex items-center px-2 rounded-lg text-blue-600 hover:bg-blue-200 active:bg-blue-400 hover:text-blue-800 cursor-pointer py-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-layout-dashboard"><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></svg>
