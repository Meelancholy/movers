<!-- resources/views/components/hr1-navbar.blade.php -->
<nav :class="open ? 'translate-x-64' : 'translate-x-0'" class="bg-white p-4 shadow-lg flex transition-transform duration-300 ease-in-out z-50">
    <div class="container flex justify-between items-center">
        <!-- Sidebar toggle button -->
        <button @click="open = !open; rotate = !rotate" class="text-blue-600 hover:text-blue-800 focus:outline-none">
