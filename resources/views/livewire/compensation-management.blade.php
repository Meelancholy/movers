<div class="min-h-full bg-white p-4 sm:p-6 rounded-lg shadow-md">
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
        ...
        <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
            @livewire('compensation-and-benefits.add-incentives-modal')
                ...
                <table class="min-w-full bg-white border table-auto md:w-full">
                    ...
                    <tbody x-ref="employees">
                        ...
                        >
                            ...
                            <td class="text-blue-800"><strong>₱{{ number_format($employee->bonuses->sum('amount'), 2) }}</strong></td>
                            <td class="text-red-800"><strong>₱{{ number_format($employee->deductions->sum('amount'), 2) }}</strong></td>
